...
const projects = [
  {
    ...
    detailPage: "/project/eval-guard",
    image: evalGuardImage, featured: true,
  },
  {
    id: "video-to-text", n: "02",
...
export default function Projects() {
  ...
  useEffect(() => {
    document.title = "Projects — Sheng Yan";
  }, []);
